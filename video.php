	...
	<div class="row-fluid">
		...
		<div class="span12">
			...
			<div class="btn-group" style="width: 320px">
			  <a href="#" class="btn" onclick="rewind('<?php echo $_GET['id'];?>', '<?php echo $_GET['sess_id'];?>')">|&lt;&lt;</a>
			  <a href="#" class="btn" id="btn_play" onclick="pap('<?php echo $_GET['id'];?>', '<?php echo $_GET['sess_id'];?>')">&gt;</a>
			  <a href="#" class="btn" onclick="forward('<?php echo $_GET['id'];?>', '<?php echo $_GET['sess_id'];?>')">&gt;&gt;|</a>
			</div>
			</center>
		</div>
	</div>
